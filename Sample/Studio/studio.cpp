...
bool csApp::OnInit(void)
{
    ...
    wxXmlResource::Get()->Load(f.GetPath() + "/studio_resources.xrc");
...
void csApp::InitToolBar(wxToolBar* toolBar)
{
    ...
    toolBar->AddTool(wxID_NEW, _T("New file"), *bitmaps[0]);
    toolBar->AddTool(wxID_OPEN, _T("Open file"), *bitmaps[1]);
    toolBar->AddTool(wxID_SAVE, _T("Save file"), *bitmaps[2]);
    toolBar->AddSeparator();
    toolBar->AddTool(wxID_PRINT, _T("Print"), *bitmaps[6]);
    toolBar->AddSeparator();
    toolBar->AddTool(wxID_COPY, _T("Copy"), *bitmaps[3]);
    toolBar->AddTool(wxID_CUT, _T("Cut"), *bitmaps[4]);
    toolBar->AddTool(wxID_PASTE, _T("Paste"), *bitmaps[5]);
    toolBar->AddSeparator();
    toolBar->AddTool(wxID_UNDO, _T("Undo"), *bitmaps[8]);
    toolBar->AddTool(wxID_REDO, _T("Redo"),  *bitmaps[9]);
    toolBar->AddSeparator();
    toolBar->AddTool(wxID_HELP, _T("Help"), *bitmaps[7]);
...
void csApp::CreateDiagramToolBar(wxFrame* parent)
{
    ...
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_ALIGNL, _T("Align left"), *bitmaps[0]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_ALIGNR, _T("Align right"), *bitmaps[1]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_ALIGNT, _T("Align top"), *bitmaps[2]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_ALIGNB, _T("Align bottom"), *bitmaps[3]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_ALIGN_HORIZ, _T("Align horizontally"), *bitmaps[4]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_ALIGN_VERT, _T("Align vertically"), *bitmaps[5]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_COPY_SIZE, _T("Copy size"), *bitmaps[6]);
    m_diagramToolBar->AddSeparator();
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_LINE_ARROW, _T("Toggle arrow"), *bitmaps[7]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_NEW_POINT, _T("New line point"), *bitmaps[8]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_CUT_POINT, _T("Cut line point"), *bitmaps[9]);
    m_diagramToolBar->AddTool(DIAGRAM_TOOLBAR_STRAIGHTEN, _T("Straighten lines"), *bitmaps[10]);
